<div style="display: flex; max-width: 1200px; margin: 0 auto;">
  ...
  <div style="background-color: #002B5B; padding: 20px; color: #FFFFFF; font-family: Arial, sans-serif; flex-grow: 1;">
    ...
    <h1>Welcome!</h1>
    <p>I offer personalized tutoring sessions for Algebra, Pre-Calculus, and Statistics. Math can be challenging, but my goal is to make it accessible and engaging for everyone. Let’s work together to build confidence and simplify difficult topics.</p>
